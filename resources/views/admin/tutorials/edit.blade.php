					...
					<div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h3 class="card-title main-head">Update Tutorial</h3>
                                </div>
                                <a href="{{ route('all-tutorials') }}" class="btn btn-primary">Back</a>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-horizontal repeater" action="{{ route('tutorial.update', $tutorial->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-7">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $tutorial->title) }}" placeholder="Enter title">
                                                        @error('title')
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="link" name="link" value="{{ old('link', $tutorial->link) }}" placeholder="Enter link">
                                                        @error('link')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        @if($tutorial->image != NULL)
                                                            <img class="mt-3" src="{{ asset($tutorial->image) }}" style="width:250px" />
                                                        @endif
                                                    </div>
                                                </div>
